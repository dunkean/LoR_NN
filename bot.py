...
def loop(challenger = True, bot = False):
    ## LAUNCH GAME
    LoR = ()
    print("Legends of Runeterra hooked.")

    ## SELECT OPPONENT
    # if bot == True:
    #     LoR.wait_and_click(["Play", "vsAI"])
    # else:
    #     # Select matchup
    #     if challenger == True:
    #         LoR.wait_and_click(["Friends", "Spare", "Challenge"])
    #     else:
    #         LoR.wait_and_click(["Accept"])

    ## SELECT DECK
    # while LoR.is_deck_selection() == False:
    #     time.sleep(0.5)
